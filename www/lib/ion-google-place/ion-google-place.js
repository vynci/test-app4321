...
function($ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document) {
  return {
    ...
    link: function(scope, element, attrs, ngModel) {
      ...
      '<div class="bar bar-header item-input-inset" style="padding: 30px 18px 30px 19px;">',
      '<label class="item-input-wrapper">',
      '<i class="icon ion-ios7-search placeholder-icon"></i>',
      '<input class="google-place-search" type="search" ng-model="searchQuery" placeholder="' + (attrs.searchPlaceholder || 'Type an address, place or ZIP code') + '">',
      '</label>',
